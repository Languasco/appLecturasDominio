    ...
    public class DCorte
    {
        ...
        public bool Capa_Dato_ListaExcelcorte(string fileLocation, int usuario, int idlocal, string idfechaAsignacion)
        {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_D_TEMPORAL_CORTE_V2", con))
                    {
                    ...
                    using (SqlBulkCopy bulkCopy = new SqlBulkCopy(con))
                    {
                        ...
                        bulkCopy.DestinationTableName = "TEMPORAL_CORTE_V2";
                        bulkCopy.WriteToServer(dt);
                        //Actualizando campos 
                        string Sql = "UPDATE TEMPORAL_CORTE_V2 SET   loc_id ='" + idlocal + "' , idUsuarioExport='" + usuario + "', fechaAsignacion='" + idfechaAsignacion + "'  WHERE idUsuarioExport IS NULL   ";
        ...
        public List<CorteTemporalCorte> Capa_Dato_Listar_Temporal_cortes_Agrupado(string fechaAsignacion, int cod_usuario, int idServicio)
        {
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_LISTAR_CORTE_TEMPORAL_CORTE_V2_AGRUPADO", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@USUARIO", SqlDbType.Int).Value = cod_usuario;
        ...
        public string Capa_Dato_Guardar_InformacionCorte(string fechaAsignacion, int id_servicio, string nombre_archivo, int usuario)
        {
            ...
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_I_IMPORTAR_EXCEL_CORTES_GRABAR", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool Capa_Dato_ListaExcelreconexiones(string fileLocation, int usuario, int idlocal, string idfechaAsignacion)
        {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(cadenaCnx))
                {
                    con.Open();
                    //eliminando registros del usuario
                    using (SqlCommand cmd = new SqlCommand("SP_D_TEMPORAL_RECONEXIONES_V3", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@id_usuario", SqlDbType.Int).Value = usuario;
                    ...
                    using (SqlBulkCopy bulkCopy = new SqlBulkCopy(con))
                    {
                        ...
                        bulkCopy.BatchSize = 500;
                        bulkCopy.NotifyAfter = 1000;
                        bulkCopy.DestinationTableName = "TEMPORAL_RECONEXIONES_V3";
                        bulkCopy.WriteToServer(dt);

                        //Actualizando campos 

                        string Sql = "UPDATE TEMPORAL_RECONEXIONES_V3 SET   loc_id ='" + idlocal + "' , idUsuarioExport='" + usuario + "', fechaAsignacion='" + idfechaAsignacion + "'  WHERE idUsuarioExport IS NULL   ";
        ...
        public List<CorteTemporalCorte> Capa_Dato_Listar_Temporal_reconexiones_Agrupado(string fechaAsignacion, int cod_usuario, int idServicio)
        {
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_LISTAR_RECONEXION_TEMPORAL_RECONEXIONES_V3", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@USUARIO", SqlDbType.Int).Value = cod_usuario;
        ...
        public string Capa_Dato_Guardar_InformacionReconexiones(string fechaAsignacion, int id_servicio, string nombre_archivo, int usuario)
        {
            ...
            try
            {
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_I_IMPORTAR_EXCEL_RECONEXIONES_GRABAR_V3", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
