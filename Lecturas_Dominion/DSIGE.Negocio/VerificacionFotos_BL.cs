...
namespace DSIGE.Modelo
{
    public class VerificacionFotos_BL
    {
        ...
        public string Capa_Negocio_EnviarFotosSinObservacion(string lecturas , int id_usuario)
        {
            try
            {
                Cls_Dato_VerificacionFotos Objeto_Dato = new Cls_Dato_VerificacionFotos();
                return Objeto_Dato.Capa_Dato_EnviarFotosSinObservacion(lecturas, id_usuario);
            }
            catch (Exception e)
            {
                throw e;
